...
sub printNotes
{
  ...
  my $result = Foswiki::Plugins::FootNotePlugin::Note::printNotes($params{"LIST"});
  return "" if ($result eq "");
...
sub noteHandler
{
  Foswiki::Func::writeDebug( __PACKAGE__, "::noteHandler( $_[0], $_[1] )" ) if $debug;
...
### my ( $text, $topic, $web ) = @_;   # do not uncomment, use $_[0], $_[1]... instead
  ...
  Foswiki::Func::writeDebug( __PACKAGE__, "::commonTagsHandler( $_[1], $_[2] )" ) if $debug;
